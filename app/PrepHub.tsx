          ...
          <div className="meeting-stage">
            {meetingSlide === 0 ? (
              <div className="meeting-card opener-card">
                ...
                <p>“I’m Johnson, founder of Opyjo Consulting in Ontario. We build learning products. We have created a separate tool that helps an education business choose the best activity for each learner. The working foundation is built and tested internally. The research question is whether it can make good choices with very little learner information and whether those choices help people remember more. I’d like your guidance on whether this work fits IRAP and how we should structure the project.”</p>
  ...
  return (
    <>
      ...
      <section className="opener">
        <div><span>Recommended opener · ~45 seconds</span><blockquote>“I’m Johnson, founder of Opyjo Consulting in Ontario. We build learning products. We have created a separate tool that helps an education business choose the best activity for each learner. The working foundation is built and tested internally. The research question is whether it can make good choices with very little learner information and whether those choices help people remember more. I’d like your guidance on whether this work fits IRAP and how we should structure the project.”</blockquote></div>
